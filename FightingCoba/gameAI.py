...
class fighterGameAITraining:
  ...
  def resetGame(self):
    ...
    self.fighter_2 = FighterAIRLvAIBT2(2, 650, 330, True, self.WARRIOR2_DATA, self.warrior2_sheet, self.WARRIOR2_ANIMATION_STEPS, self.magic_fx, self.screen_width)
